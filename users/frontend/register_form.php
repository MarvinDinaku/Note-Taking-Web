...
<div id="registerModal" class="modal-fade">
    ...
    <form class="modal-content" id="registerForm" name="registerForm" >
        <div class="container">
            ...
            <input id="usr" type="text" placeholder="Username" name="usr" required>
            ...
            <input id="cpass" type="password" placeholder="Confirm Password" name="confirm_password" required>
            ...
            <div class="clearfix">
                ...
                <button type="button" class="signupbtn" onclick="submitContactForm()">Sign Up</button>
            </div>
        </div>
    </form>
</div>
...
<div class="modal fade" id="errorModalExists" role="dialog">
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="noteTitle">Email already exists</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="noteTitle">Passwords do not match</label>
...
<div class="modal fade" id="errorModalShort" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        <label for="noteTitle">Passwords to short</label>
...
<script>
    ...
    function submitContactForm(){
        ...
        if(email.trim() == '' ){
            ...
            $.ajax({
                type:'POST',
                url:'../backend/register_validation.php',
                data:'email='+email+'&password='+password+'&confirm_password='+cpass+'&first_name='+firstName+'&last_name='+lastName+'&usr='+usr,
                dataType:'JSON',
                success:function(data){

                    //If posting successful then append the new note without reloading page
					if(data=="Short"){
						$('#errorModalShort').modal('show');
					}
                    if(data=="Error"){
						$('#errorModal').modal('show');
					}else if(data=="Exists"){
						$('#errorModalExists').modal('show');
